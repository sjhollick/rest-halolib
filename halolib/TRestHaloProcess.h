...
#ifndef RESTProc_TRestHaloProcess
#define RESTProc_TRestHaloProcess
...
class TRestHaloProcess : public TRestEventProcess {
private:
    /// A pointer to the specific TRestEvent input event
    TRestEvent* fEvent;  //!
...
const char* GetProcessName() const override { return "CHANGEME!"; }
    ...
    ClassDefOverride(TRestHaloProcess, 1);
